...
var truncateLines = function truncateLines(str) {
...
var downloadTemplate = function downloadTemplate(format, nodeId) {
...
var downloadMultiTemplate = function downloadMultiTemplate(format, nodesToDownload, allRoutes, clickingNodeName, dictionaryVersion) {
  if (format !== 'tsv' && format !== 'json') {
    return;
  }
...
exports.downloadMultiTemplate = downloadMultiTemplate;
var graphStyleConfig = {
  nodeTextFontSize: 10,
  nodeTextLineGap: 4,
  nodeContentPadding: 20,
  nodeIconRadius: 10
};
exports.graphStyleConfig = graphStyleConfig;
var parseDictionaryNodes = function parseDictionaryNodes(dictionary) {
...
exports.parseDictionaryNodes = parseDictionaryNodes;
var getPropertyDescription = function getPropertyDescription(property) {
  var description;
 ...
 */
var getSearchHistoryItems = function getSearchHistoryItems() {
...
var addSearchHistoryItems = function addSearchHistoryItems(searchHistoryItem) {
 ...
 */
exports.addSearchHistoryItems = addSearchHistoryItems;
...
var MatchedIndicesShape = _propTypes["default"].arrayOf(_propTypes["default"].arrayOf(_propTypes["default"].number));
exports.MatchedIndicesShape = MatchedIndicesShape;
var MatchedItemShape = _propTypes["default"].shape({
  indices: MatchedIndicesShape,
  arrayIndex: _propTypes["default"].number,
  key: _propTypes["default"].string,
  value: _propTypes["default"].string
});
exports.MatchedItemShape = MatchedItemShape;
var SearchItemPropertyShape = _propTypes["default"].shape({
...
exports.SearchItemPropertyShape = SearchItemPropertyShape;
var SearchItemShape = _propTypes["default"].shape({
  id: _propTypes["default"].string,
  title: _propTypes["default"].string,
  description: _propTypes["default"].string,
  properties: _propTypes["default"].arrayOf(SearchItemPropertyShape)
});
exports.SearchItemShape = SearchItemShape;
...
exports.SearchResultItemShape = SearchResultItemShape;
var onViewChange = function onViewChange(payload) {
  localStorage.setItem('reactflowGraphView', JSON.stringify(payload));
  return payload;
};
exports.onViewChange = onViewChange;
var onCnavasWidthChange = function onCnavasWidthChange(_ref) {
...
exports.onCnavasWidthChange = onCnavasWidthChange;