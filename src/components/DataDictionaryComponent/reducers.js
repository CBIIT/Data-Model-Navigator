...
const toggleCheckBoxAction = (payload, currentAllFilterVariables) => {
  ...
  //   payload: {
  //     filter: {
  //       groupName: payload[0].groupName,
  //       name: [payload[0].name],
  //       isChecked: payload[0].isChecked,
...
const generateCount = (filtered, searchGroup, searchTerm, flag,
...
const categoryexemptSubjectCount = (
  ...
  switch (groupName) {
    case 'category':
      return {
        administrative: generateCount(unfiltered,
