...
const generateNodes = (nodes, edges, windowWidth) => {
  ...
  const generatedNodes = nodes.map((node, index) => {
    ...
    // let randomX;
    // console.log(`math x ${index}`, {
    //   has: xCordinateSet.has(randomX),
    //   range: Math.abs(xCordinate[0] - randomX) < 100,
    // });
    // let xFlag = false;
    // do  {
    //   console.log(`math x ${index}`, {
    //     randomX,
    //     xCordinate: xCordinate[0],
    //     xCordinateSet
    //   });
    //   randomX = _.random(0, 1000)
    // } while (Math.abs(xCordinate[0] - randomX) < 100)
    // xCordinate.pop();
    // xCordinate.push(randomX);
    // xCordinateSet.add(randomX);

    // let randomY = _.random(10,800)
    // console.log(`math y ${index}`, Math.abs(yCordinate[0] - randomY) < 100)
    // while (yCordinateSet.has(randomY) && Math.abs(yCordinate[0] - randomY) < 100) {
    //   console.log(`math y ${index}`, {
    //     randomY,
    //     yCordinate: yCordinate[0],
    //     yCordinateSet
    //   });
    //   randomY = _.random(10, 800)
    // }
    // yCordinate.pop();
    // yCordinate.push(randomY);
    // yCordinateSet.add(randomY)
