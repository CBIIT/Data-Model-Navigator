...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /* eslint-disable no-plusplus */
var theme = {
  overrides: {
    MuiList: {
      padding: {
...
var addHighlightingSpans = exports.addHighlightingSpans = function addHighlightingSpans(str, indices, spanClassName) {
  var cursor = 0;
...
var getPropertyNameFragment = exports.getPropertyNameFragment = function getPropertyNameFragment(propertyName, matchedItem, spanClassName) {
...
var getPropertyTypeFragment = exports.getPropertyTypeFragment = function getPropertyTypeFragment(property, typeMatchList, spanClassName) {
...
var getPropertyDescriptionFragment = exports.getPropertyDescriptionFragment = function getPropertyDescriptionFragment(property, matchedItem, spanClassName) {
...
var getNodeTitleFragment = exports.getNodeTitleFragment = function getNodeTitleFragment(allMatches, title, spanClassName) {
...
var getNodeDescriptionFragment = exports.getNodeDescriptionFragment = function getNodeDescriptionFragment(allMatches, description, spanClassName) {
  var matchedItem = allMatches.find(function (item) {
...
var getMatchInsideProperty = exports.getMatchInsideProperty = function getMatchInsideProperty(propertyIndex, propertyKey, property, allMatches) {
  var nameMatch = null;
...
var getMatchesSummaryForProperties = exports.getMatchesSummaryForProperties = function getMatchesSummaryForProperties(allProperties, allMatches) {
...
var getNodeTitleSVGFragment = exports.getNodeTitleSVGFragment = function getNodeTitleSVGFragment(nodeNames, matchedNodeNameIndices, fontSize, textPadding, textLineGap) {
