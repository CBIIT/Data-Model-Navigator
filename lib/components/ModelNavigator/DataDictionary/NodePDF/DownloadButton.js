...
var _Pdf2 = _interopRequireDefault(require("../LandscapeNodePDF/Pdf"));
...
var DownloadButton = function DownloadButton(_ref) {
  var classes = _ref.classes,
    ...
    isFileManifest = _ref.isFileManifest;
  ...
  var generateFileManifest = function generateFileManifest(node) {
    ...
    mergedArr.forEach(function (_ref2) {
  ...
  var generatePdfDocument = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0, _renderer.pdf)(config.landscape ? /*#__PURE__*/_react["default"].createElement(_Pdf2["default"], {
              nodes: document,
              icon: config.catagoryIcon,
              pdfDownloadConfig: pdfDownloadConfig
            }) : /*#__PURE__*/_react["default"].createElement(_Pdf["default"], {
              nodes: document
            })).toBlob();
          case 3:
            blob = _context.sent;
    ...
    return function generatePdfDocument(_x) {
  ...
  var downloadTsv = function downloadTsv() {
    var tsv = isFileManifest ? generateFileManifest(documentData) : convertToTSV(documentData);
    var exportData = new Blob([tsv], {
      type: 'data:text/tab-separated-values'
    });
    (0, _fileSaver.saveAs)(exportData, "".concat(fileName, ".tsv"));
  };
  ...
  var btnClass = config.type === 'document' ? (0, _clsx["default"])(classes.headerButton, classes.documentDownloadBtn) : (0, _clsx["default"])(classes.headerButton, classes.nodeDownloadBtn);
  ...
  }, isLoading ? ' Loading document... ' : config.image ? /*#__PURE__*/_react["default"].createElement("img", {
...
var _default = exports["default"] = (0, _core.withStyles)(styles)(DownloadButton);