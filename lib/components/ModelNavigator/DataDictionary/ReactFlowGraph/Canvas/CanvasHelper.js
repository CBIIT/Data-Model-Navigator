 ...
 * 
 */
var generateNodeTree = function generateNodeTree(dictionary) {
...
* @param {*} nodeTree
*/
exports.generateNodeTree = generateNodeTree;
var generateSubTree = function generateSubTree(dictionary, nodeTree) {
  var nodes = Object.keys(dictionary);
  var subtree = {};
  var nextLevel = 0;
 ...
 * 
 */
exports.generateSubTree = generateSubTree;
var getNodePosition = function getNodePosition(_ref) {
