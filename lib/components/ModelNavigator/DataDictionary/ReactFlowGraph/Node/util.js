 ...
 */
var setMatchingNodeClasses = exports.setMatchingNodeClasses = function setMatchingNodeClasses(_ref, node, classes, category) {
  ...
  return (0, _clsx2["default"])(classes.nodeTitleBtn, classes[category], _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, classes.matchedNodeIDs, matchedNodeIDs.indexOf(id) !== -1), classes.matchedInNameAndDesc, matchedNodeIDsInNameAndDescription.indexOf(id) !== -1), classes.matchedNodeIDsInProps, matchedNodeIDsInProperties.indexOf(id) !== -1 && matchedNodeIDsInNameAndDescription.indexOf(id) === -1), classes.excludeNode, matchedNodeIDs.indexOf(id) === -1));
};

/**
 * highlight the matching string based on search query result
 */
var highlightMatchingTitle = exports.highlightMatchingTitle = function highlightMatchingTitle(node) {
